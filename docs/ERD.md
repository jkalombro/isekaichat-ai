...
| totalTokensConsumed | number | Cumulative tokens consumed by this character |
| lastCalculationDatetime | timestamp | Last time the token total was updated |
...
| tokensConsumed | number | Tokens consumed by this specific message |
...
erDiagram
    ...
    CHARACTER {
        ...
        timestamp lastCalculationDatetime
        timestamp createdAt
    }
