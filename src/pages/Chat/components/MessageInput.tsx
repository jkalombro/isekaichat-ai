    ...
    <footer className="p-6 border-t border-border bg-background">
      <form onSubmit={handleSendMessage} className="max-w-3xl mx-auto flex items-end gap-3">
        <textarea
          ...
          spellCheck={false}
          rows={1}
          className="flex-1 bg-muted/50 border border-border focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary min-h-[48px] max-h-[200px] rounded-2xl p-3 resize-none text-sm leading-relaxed scrollbar-hide"
        />
        <Button 
          type="submit" 
